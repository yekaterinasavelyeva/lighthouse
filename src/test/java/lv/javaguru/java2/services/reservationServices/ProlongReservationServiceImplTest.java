...
import lv.javaguru.java2.services.reservationServices.validate.ReservationDateToValidator;
...
public class ProlongReservationServiceImplTest {
    ...
    private ReservationDateToValidator dateToValidator;
    ...
    public void init() {
        ...
        dateToValidator = mock(ReservationDateToValidator.class);
