...
import lv.javaguru.java2.services.reservationServices.validate.ReservationValidatorImpl;
...
public class ReservationFactoryImpl implements ReservationFactory {
    ...
    private void validateReservationsForResourceAreClosed(Long resourceId) {
        ...
        if (thereAreOpenedReservations) {
            throw new IllegalArgumentException("There are opened reservations for this resource. Cannot create new reservationServices.");
        }
    }
}
